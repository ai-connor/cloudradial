...
const (
	FEEDBACKTYPE__0       FeedbackType = 0
	FEEDBACKTYPE__1       FeedbackType = 1
	FEEDBACKTYPE__MINUS_1 FeedbackType = -1
)
...
func NewFeedbackTypeFromValue(v int32) (*FeedbackType, error) {
	ev := FeedbackType(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
