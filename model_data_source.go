...
// List of DataSource
const (
	DATASOURCE__0   DataSource = 0
	DATASOURCE__1   DataSource = 1
	DATASOURCE__2   DataSource = 2
	DATASOURCE__5   DataSource = 5
	DATASOURCE__10  DataSource = 10
	DATASOURCE__20  DataSource = 20
	DATASOURCE__30  DataSource = 30
	DATASOURCE__100 DataSource = 100
)
